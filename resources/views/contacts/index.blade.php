            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('contacts.create') }}"
                        class="px-4 py-2 bg-indigo-500 rounded hover:bg-indigo-700 my-2 ring-indigo-300 border border-indigo-200 text-black">Create
                        Contact</a>
                </div>
                    ...
                    @foreach($contacts as $contact)
                        <tr>
                            ...
                            <td class="p-2 flex justify-center">
                                <img src="{{ Storage::url($contact->avatar) }}" class="h-20 w-20" />
                            </td>
                            <td class="border p-2">{{ $contact->phone_number }}</td>
                            <td class="border p-2">{{ $contact->gender }}</td>
                            <td class="border p-2">
                                <a href="{{route('contacts.edit', $contact)}}" class="text-indigo-700 hover:text-gray-600">Edit</a>
